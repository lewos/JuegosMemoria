...
public class IdentificacionObjetosFrame extends BaseViewFrame {
	...
	public IdentificacionObjetosFrame(Controlador controller) {
		super(controller);
	}
	...
	private void continuar() {
		IdentificacionObjetosFrame rf = new IdentificacionObjetosFrame(controller);
		this.setVisible(false);
		rf.setVisible(true);
	}

	public class OriginActionListener implements ActionListener {
		private IdentificacionObjetosFrame frame;
		private ButtonValue bv;

		public OriginActionListener(IdentificacionObjetosFrame frame, ButtonValue bv) {
			this.frame = frame;
			this.bv = bv;
		}
	...
	public class DestinationActionListener implements ActionListener {
		...
		public DestinationActionListener(IdentificacionObjetosFrame frame, ButtonValue bv) {
			this.frame = frame;
			this.bv = bv;
		}
		...
		public void actionPerformed(ActionEvent e) {
			...
			try {                          //origen = pregunta | destino = respuesta
				this.frame.controller.procesarAccion(origen.getValue(), destino.getValue());
